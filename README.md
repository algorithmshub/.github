...
Default files for [@AlgorithmsHub](https://github.com/AlgorithmsHub) repositories.

GitHub will use and display default files for any public repository in [@AlgorithmsHub](https://github.com/AlgorithmsHub) organization that does not have its own file of that type in any of the following places:
